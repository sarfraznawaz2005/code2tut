  ...
  getSchema() {
    return z.object({
      ...
      relationships: z.array(z.object({
        from_abstraction: z.string(),
        to_abstraction: z.string(),
        label: z.string(),
      })),
    });
  }
...
\`\`\`json
{
  "summary": "A brief, simple explanation of the project. Can span multiple lines with **bold** and *italic* for emphasis.",
  "relationships": [
    {
...
`;
    ...
    if (!relationshipsData || !relationshipsData.summary || !relationshipsData.relationships) {
